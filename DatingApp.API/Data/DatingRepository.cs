...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            return await _context.Likes.FirstOrDefaultAsync(u => u.LikeeId == recipientId && u.LikerId == userId);
        }
        ...
        public async Task<PagedList<Message>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            switch(messageParams.MessageContainer)
            {
                ...
                case "Outbox":
                    ...
                    break;
                default:
                    messages = messages.Where(u => u.RecipientId == messageParams.UserId && u.IsRead == false && u.RecipientDeleted == false && u.IsRead == false);
                    break;
            }
